...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        master.config(background="skyblue")
        self.createWidget()

    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="PeachPuff2", width="300", height="2", font=("Calibri", 20))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login",font=("calibri",20),bg="pink", height="2", width="300", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register",font=("calibri",20),bg="pink", height="2", width="300", command = self.btnRegister_Click)
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",font=("calibri",20,"bold"),bg="blue",fg="white")
        self.lblMsg.pack()
        self.username=Label(self, text="Username * ",font=("calibri",20,"bold"),bg="skyblue",fg="black")
        self.username.pack()
        self.username_verify = StringVar()
        self.username_login_entry = Entry(self, textvariable=self.username_verify)
        self.username_login_entry.pack()
        self.password=Label(self, text="Password * ",font=("calibri",20,"bold"),bg="skyblue",fg="black")
        self.password.pack()
        self.password_verify = StringVar()
        self.password_login_entry = Entry(self, textvariable=self.password_verify, show='*')
        self.password_login_entry.pack()
        self.btnLogin=Button(self, text="Login",font=("calibri",20,"bold"),bg="lightgreen",fg="black", width=10, height=1, command=self.btnLogin_Click)
        self.btnLogin.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below",font=("calibri",20), bg="blue",fg="white")
        self.lblMsg.pack()
        self.username_lable = Label(self, text="Username * ",font=("calibri",20,"bold"),bg="skyblue",fg="black")
        self.username_lable.pack()
        self.username = StringVar()
        self.username_entry = Entry(self, textvariable=self.username)
        self.username_entry.pack()

        self.password_lable = Label(self, text="Password * ",font=("calibri",20,"bold"),bg="skyblue",fg="black")
        self.password_lable.pack()
        self.password = StringVar()
        self.password_entry = Entry(self, textvariable=self.password, show='*')
        self.password_entry.pack()
        self.btnRegister=Button(self, text="Register",font=("calibri",20,"bold"),bg="lightgreen",fg="black", width=10, height=1,command=self.register_user)
        self.btnRegister.pack()
