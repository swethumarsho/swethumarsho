...
#    register_screen = Toplevel(main_screen)
    ...
    #img=Image.open(r"C:\Users\Swetha\Downloads\Health-Care-Chat-Bot-master\Camera Roll\download(2).jpg")
...
def login():
    ...
    login_screen.geometry("600x6000")
...
def register_user():
    ...
    Label(root, text="Registration Success", fg="green", font=("calibri", 20)).pack()
...
def main_account_screen(frmmain):
    ...
    Label(main_screen,text="Select Your Choice", bg="blue",fg="white",width="300", height="2", font=("Calibri", 20,"bold")).pack()
